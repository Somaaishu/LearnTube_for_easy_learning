  ...
  return (
    <div className="min-h-screen pt-24 px-6">
      <div className="max-w-6xl mx-auto py-12">
        ...
        <p className="text-muted-foreground text-center mb-12">Master technology skills from beginner to advanced.</p>
        {levels.map(level => {
          const courses = itCourses.filter(c => c.level === level);
