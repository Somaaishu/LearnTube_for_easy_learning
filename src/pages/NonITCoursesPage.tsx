...
const NonITCoursesPage = () => {
  ...
  const filtered = nonItCourses.filter(c => {
  ...
  return (
    <div className="min-h-screen pt-24 px-6">
      <div className="max-w-6xl mx-auto py-12">
        ...
        <p className="text-muted-foreground text-center mb-8">Build essential business and personal skills.</p>

        <div className="glass-card mb-8 flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
            <input type="text" placeholder="Search Non-IT courses..." value={search} onChange={e => setSearch(e.target.value)} className="glass-input w-full pl-10 text-foreground text-sm" />
          </div>
